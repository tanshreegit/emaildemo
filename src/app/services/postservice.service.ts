...
export class PostserviceService {
  ...
  constructor(private afs: AngularFirestore, private firebase: AngularFireDatabase,private httpClient:HttpClient) {
  ...
  public getNews(){
    return this.httpClient.get(`https://rc-vault-fap-live-1.azurewebsites.net/api/gettimeentries?code=${this.key}`);
  }
